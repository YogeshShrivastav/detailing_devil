...
export class FranchiseServiceListComponent implements OnInit {
...
redirect_next() {
  ...
  franchise_saleinvoice(){
    ...
    this.db.post_rqst( {'filter':this.filter ,'franchise_id':this.franchise_id }, 'stockdata/get_franchise_service?page='+this.current_page )
    .subscribe(data => {
