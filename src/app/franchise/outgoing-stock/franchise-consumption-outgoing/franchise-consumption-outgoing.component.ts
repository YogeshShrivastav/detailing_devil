...
@Component({
  selector: 'app-franchise-consumption-outgoing',
  templateUrl: './franchise-consumption-outgoing.component.html'
})
export class FranchiseConsumptionOutgoingComponent implements OnInit {
...
console.log( params);
  ...
  getProductDetail() {
    ...
    this.db.post_rqst(  { 'stock_id':this.stock_id , 'franchise_id': this.franchise_id }, 'stockdata/franchise_consumption_outgoing')
      .subscribe(d => {
        console.log(d);
