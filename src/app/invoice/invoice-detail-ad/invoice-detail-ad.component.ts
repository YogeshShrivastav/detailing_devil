...
@Component({
  selector: 'app-invoice-detail-ad',
  templateUrl: './invoice-detail-ad.component.html'
})
export class InvoiceDetailAdComponent implements OnInit {
  ...
  constructor(public db: DatabaseService,
    ...
    salesInvoiceDetail(invoice_id) {
      ...
      this.db.get_rqst(  '', 'sales/getSalesInvoice/' + invoice_id)
      .subscribe(data => {
        ...
        if( !this.invoiceDetail ){ 
          this.dialog.warning('This Invoice has been Deleted!'); 
