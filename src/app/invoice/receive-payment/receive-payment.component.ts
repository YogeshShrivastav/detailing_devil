...
export class ReceivePaymentComponent implements OnInit {
  ...
  receive_payments() {
    ...
    this.db.insert_rqst( {'data': this.formData } , 'sales/payment_receiving')
      .subscribe(data => {
      this.sendingData = false;
        this.dialog.success('Payment Received Successfully')
  ...
  getPendingPayment() {
    ...
    this.db.post_rqst( {'data':this.formData}, 'sales/getPendingPayment')
      .subscribe(data => {
        console.log(data);
    this.sendingData = false;
