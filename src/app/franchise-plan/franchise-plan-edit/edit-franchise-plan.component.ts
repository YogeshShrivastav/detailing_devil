...
import {Brand} from '../../product/add-product/add-product.component';
import {FranchisePlan} from '../add-franchise-plan/add-franchise-plan.component';

@Component({
  selector: 'app-edit-franchise-plan',
  templateUrl: './edit-franchise-plan.component.html'
  // styleUrls: ['./edit-product.component.scss']
})

export class EditFranchisePlanComponent implements OnInit {
  form: any = {};
  data: any = [];
  ...
  ngOnInit() {
    ...
    this.route.params.subscribe(params => {
      this.franchise_plan_id = params['id'];
    
    if (this.franchise_plan_id) { this.franchisePlanData(this.franchise_plan_id); }
  ...
  franchisePlanData(f_p_id) {
    this.db.get_rqst( '', 'franchise_plans/' + f_p_id + '/edit')
      .subscribe(data => {
        console.log( data );
      
        this.form = data.data.franchise_plan;
        this.initial_stock = data.data.initial_stock;
...
console.log(this.initial_stock);
  ...
  saveFranchisePlan() {
      ...
      // if (!this.form.accessories) {
        ...
        this.db.post_rqst({ 'data': this.formData, 'initial_stock': this.initial_stock }, 'franchise_plans/update')
        .subscribe(d => {
              this.router.navigate(['/franchise_plans']);
