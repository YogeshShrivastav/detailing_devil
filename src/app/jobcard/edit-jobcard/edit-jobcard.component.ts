  ...
  constructor(public formBuilder: FormBuilder,
    ...
    get_category(){
      ...
      .subscribe((data:any) => { 
        ...
        // for (let i = 0; i < this.cat_type_arr.length; i++) {
        //   this.cat_type_arr[i].checked = this.cat_type_arr[i].checked || 0;
    ...
    getPlan(){
      ...
      .subscribe((data:any) => { 
        ...
        for (let i = 0; i < this.plan_name_arr.length; i++) {
          // const element = this.plan_name_arr[i].category_type;
    ...
    checkService(plan_name : any,category_type){
      ...
      for (let j = 0; j < this.plan_name_arr.length; j++) {
        ...
        if(category_type == this.plan_name_arr[j].category_type){
          // this.plan_name_arr[index].disabled = true;
      ...
      // var index = this.plan_name_arr.findIndex(x => x.plan_name === plan_name && x.category_type === category_type );
      // if(index > '-1'){
      //   this.plan_name_arr[index].disabled = true;
      // }
      ...
      //     if( this.JobCardForm.value.services.indexOf( plan_name ) > '-1' ){
      //       this.plan_disabled = plan_name;
      //       this.category_disabled = x;
      
      //     }else{
      //       this.plan_disabled = '';
      //       this.category_disabled = '';
      //     }
      // console.log(this.plan_disabled);
      // console.log(plan_name);
      ...
      // var s_index = this.JobCardForm.value.services.indexOf( this.plan_name_arr[j].plan_name ) 
      // if(s_index > '-1' ){
      // console.log(  this.plan_name_arr[j].plan_name );
      
      // if(this.JobCardForm.value.cat_type.indexOf( this.plan_name_arr[j].category_type ) > '-1' ){
      // this.plan_name_arr[j].checked = 2;
      // console.log(this.plan_name_arr[j].category_type);
      // console.log(this.cat_type_arr);
      
      // var x = this.cat_type_arr.indexOf( this.plan_name_arr[j].category_type );
      // console.log(x);
      
      // for (let i = 0; i < this.cat_type_arr.length; i++) {
      //   if(this.plan_name_arr[j].category_type == this.cat_type_arr[i].category_type){
      //     this.cat_type_arr[i].checked++;
      //     if(this.cat_type_arr[i].checked > 1){
      //       this.dialog.warning('Exist');
      //       this.cat_type_arr[i].checked--;
      //       this.JobCardForm.value.services.splice(s_index, -1);
      //       }
      //   }
      ...
      // }else{
      // this.plan_name_arr[j].checked = 1;
    ...
    submit_form(){
      ...
      if(this.JobCardForm.invalid)
      {
        ...
        // this.JobCardForm.get('email').markAsTouched();
        // this.JobCardForm.get('contact_no').markAsTouched();
        // this.JobCardForm.get('address').markAsTouched();
        this.JobCardForm.get('vehicle_type').markAsTouched();
        this.JobCardForm.get('cat_type').markAsTouched();
        // this.JobCardForm.get('make').markAsTouched();
        // this.JobCardForm.get('modal_no').markAsTouched();
        // this.JobCardForm.get('color').markAsTouched();
        // this.JobCardForm.get('year').markAsTouched();
        this.JobCardForm.get('reg_no').markAsTouched();
        // this.JobCardForm.get('chasis_no').markAsTouched();
        this.JobCardForm.get('srs').markAsTouched();
        this.JobCardForm.get('services').markAsTouched();
        // this.JobCardForm.get('technician').markAsTouched();
        return;
      }
      // this.loading_list = true;
      ...
      .subscribe(data => {
        ...
        if(data['data'].msg == 'NOT' ){
          this.dialog.warning('Date Created is Less than already Job creaed! ');
          return;
        }
