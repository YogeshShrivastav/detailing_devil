<?php
	...
	$app->group(['middleware' => 'auth:api', 'namespace' => 'App\Http\Controllers\Admin', 'prefix' => 'stockdata'],  function () use ($app) {
		...
		$app->post('visit_data/remove', ['uses' => 'StockController@removeVisitData']);
		$app->post('remove', ['uses' => 'StockController@removeProduct']);
	...
	$app->group(['middleware' => 'auth:api', 'namespace' => 'App\Http\Controllers\Admin', 'prefix' => 'franchise_leads'],  function () use ($app) {
			...
			$app->post('consumerAssignSalesAgentBulk', ['uses' => 'LeadsController@consumerAssignSalesAgentBulk']);
	...
	$app->group(['middleware' => 'auth:api', 'namespace' => 'App\Http\Controllers\Admin', 'prefix' => 'consumer_leads'],  function () use ($app) {
			...
			$app->post('un_assign_franchise/{created_by}', 'LeadsController@un_assign_franchise');
    ...
    $app->group(['middleware' => 'auth:api', 'namespace' => 'App\Http\Controllers\Admin', 'prefix' => 'franchises'],  function () use ($app) {
			...
			$app->post('check_email', ['uses' => 'FranchisesController@check_email']);
	...
	$app->group(['middleware' => 'auth:api', 'namespace' => 'App\Http\Controllers\Admin', 'prefix' => 'sales'],  function () use ($app) {
			...
			$app->post('convert_to_franchise', ['uses' => 'SalesOrderController@convert_to_franchise']);
			...
			$app->post('getServicePayment', ['uses' => 'SalesOrderController@getServicePayment']);
			...
			$app->post('service_payment_receiving', ['uses' => 'SalesOrderController@service_payment_receiving']);
			$app->post('getPendingPayment', ['uses' => 'SalesOrderController@getPendingPayment']);
			$app->post('getServicePendingPayment', ['uses' => 'SalesOrderController@getServicePendingPayment']);
			...
			$app->post('getServiceEdit', ['uses' => 'SalesOrderController@getServiceEdit']);
			$app->post('UpdateInvoice', ['uses' => 'SalesOrderController@UpdateInvoice']);
			$app->post('UpdateServiceInvoice', ['uses' => 'SalesOrderController@UpdateServiceInvoice']);
			$app->post('service_invoice_cancel', ['uses' => 'SalesOrderController@service_invoice_cancel']);
			$app->post('invoice_cancel', ['uses' => 'SalesOrderController@invoice_cancel']);
			$app->post('deleteSalesInvoiceItem', ['uses' => 'SalesOrderController@deleteSalesInvoiceItem']);
			$app->post('deleteServiceInvoiceItem', ['uses' => 'SalesOrderController@deleteServiceInvoiceItem']);
    });
    ...
    $app->group(['middleware' => 'auth:api', 'namespace' => 'App\Http\Controllers\Admin', 'prefix' => 'jobcard'],  function () use ($app) {
			...
			// $app->post('updateInvoiceDate', ['uses' => 'JobCardController@updateInvoiceDate']);
			...
			$app->post('check_is_company', ['uses' => 'JobCardController@check_is_company']);
			$app->post('update_jobCard', ['uses' => 'JobCardController@update_jobCard']);
	...
	$app->group(['middleware' => 'auth:api', 'namespace' => 'App\Http\Controllers\Admin', 'prefix' => 'customer'],  function () use ($app) {
			...
			$app->post('CancelCustomerInvoice/{card_id}/{f_id}/{created_by}', ['uses' => 'CustomerController@CancelCustomerInvoice']);
